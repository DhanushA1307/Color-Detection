...
#icon
image_icon = PhotoImage(file = "E:\codeclause\color detection with interactive application\photos\icon.png")
...
logo = PhotoImage(file = "E:\codeclause\color detection with interactive application\photos\logo.png")
